...
# spark.sql(f"""
#      insert into dwd_trade_cart_add_inc partition (dt='20250718')
#  select
#      id,
#      user_id,
#      sku_id,
...
# # dwd_trade_cart_full
# spark.sql(f"""
#  insert into dwd_trade_cart_full partition (dt="20250718")
#  select
#      id,
#      user_id,
#      sku_id,
...
# spark.sql(f"""
#      insert into dwd_tool_coupon_used_inc partition (dt='20250718')
#  select
#      id,
#      coupon_id,
#      user_id,
