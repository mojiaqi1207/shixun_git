...
insert into dwd_trade_cart_add_inc partition (dt='20250701')
select
    id,
    user_id,
    sku_id,
...
insert overwrite table dwd_trade_order_detail_inc partition (dt='20250701')
select
    od.id,
    order_id,
    user_id,
...
insert into dwd_trade_pay_detail_suc_inc partition (dt='20250701')
select
    od.id,
    pay.order_id,
    pay.user_id,
...
insert into dwd_trade_cart_full partition (dt="20250701")
select
    id,
    user_id,
    sku_id,
...
insert into dwd_trade_trade_flow_acc partition (dt='20250701')
select
    oi.id,
    oi.user_id,
    oi.province_id,
...
insert into dwd_tool_coupon_used_inc partition (dt='20250701')
select
    id,
    coupon_id,
    user_id,
...
insert into dwd_interaction_favor_add_inc partition (dt='20250701')
select
    id,
    user_id,
    sku_id,
...
insert overwrite table dwd_traffic_page_view_inc partition (dt='20250701')
SELECT
...
insert into dwd_user_register_inc partition (dt='20250701')
select
    use_r.id,
    substr(create_time,1,7),
    create_time,
...
insert overwrite table dwd_user_login_inc partition (dt = '20250701')
select user_id,
