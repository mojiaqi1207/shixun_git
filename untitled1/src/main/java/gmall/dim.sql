...
insert into dim_sku_full partition (dt='20250701')
select
    sku.id,
    sku.price,
    sku.sku_name,
...
insert into dim_activity_full partition (dt='20250701')
select
    rule.id,
    info.id,
    info.activity_name,
...
insert into dim_province_full partition (dt='20250701')
select
    pro.id,
    pro.name,
    pro.area_code,
...
insert into dim_promotion_pos_full partition (dt="20250701")
select
    id,
    pos_location,
    pos_type,
...
insert into dim_promotion_refer_full partition (dt='20250701')
select
    id,
...
insert into dim_user_zip partition (dt='20250701')
select
    id,
    name,
    phone_num,
