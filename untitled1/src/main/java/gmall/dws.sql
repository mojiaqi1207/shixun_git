...
INSERT INTO dws_trade_user_sku_order_1d PARTITION (dt='20250701')
SELECT
    od.user_id,
    od.sku_id,
    sku.sku_name,
...
insert into dws_trade_user_order_1d partition (dt='20250701')
select
    user_id,
    count(order_id),
    sum(sku_num),
...
insert overwrite table dws_trade_user_cart_add_1d partition(dt='20250701')
select
    user_id,
    count(*),
    sum(sku_num)
...
insert overwrite table dws_trade_user_payment_1d partition(dt='20250701')
select
    user_id,
...
insert overwrite table dws_trade_province_order_1d partition(dt='20250701')
select
    province_id,
    province_name,
    area_code,
...
insert overwrite table dws_tool_user_coupon_coupon_used_1d partition(dt='20250701')
select
    user_id,
    coupon_id,
    coupon_name,
...
insert overwrite table dws_interaction_sku_favor_add_1d partition(dt='20250701')
select
    sku_id,
    sku_name,
    category1_id,
...
insert overwrite table dws_traffic_session_page_view_1d partition(dt='20250701')
select
    session_id,
    mid_id,
    brand,
...
insert overwrite table dws_traffic_page_visitor_page_view_1d partition(dt='20250701')
select
    mid_id,
    brand,
    model,
...
insert overwrite table dws_trade_user_sku_order_nd partition(dt='20250701')
select
    user_id,
    sku_id,
    sku_name,
...
insert overwrite table dws_trade_province_order_nd partition(dt='20250701')
select
    province_id,
    province_name,
    area_code,
...
insert overwrite table dws_trade_user_order_td partition(dt='20250701')
select
    user_id,
...
insert overwrite table dws_user_user_login_td partition (dt = '20250701')
select
    u.id,
