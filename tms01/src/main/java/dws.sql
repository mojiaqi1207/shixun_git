...
--                    region_id
--             from tms_dim.dim_organ_full
--             where dt = '20250725') organ
--            on detail.sender_district_id = organ.region_id
--                left join
--            (select id,
--                    parent_id
--             from tms_dim.dim_region_full
--             where dt = '20250725') district
...
--              parent_id
--       from tms_dim.dim_region_full
--       where dt = '20250725') city_for_level1
...
--              parent_id
--       from tms_dim.dim_region_full
--       where dt = '20250725') province_for_level1
...
--              parent_id
--       from tms_dim.dim_region_full
--       where dt = '20250725') province_for_level2
...
-- where dt >= date_add('20250725', -recent_days + 1)
-- group by org_id,
--          org_name,
--          city_id,
--          city_name,
...
--       where dt = '20250725') for_line_name
